...
export const procDefinitions: readonly ProcDefinition[] = [
  { id: 1, name: "GetDaemonInfo", stream: "unary", requestType: "void", responseType: "DaemonInfo", errorType: "GetDaemonInfoError" },
  { id: 2, name: "StartPairing", stream: "unary", requestType: "StartPairingReq", responseType: "StartPairingRes", errorType: "StartPairingError" },
  { id: 3, name: "CompletePairing", stream: "unary", requestType: "CompletePairingReq", responseType: "CompletePairingRes", errorType: "CompletePairingError" },
  { id: 4, name: "RenewClientCredential", stream: "unary", requestType: "void", responseType: "RenewClientCredentialRes", errorType: "RenewClientCredentialError" },
  { id: 5, name: "SubscribeRoots", stream: "server", requestType: "void", responseType: "RootsTableEvent", errorType: "SubscribeRootsError" },
  { id: 6, name: "SubscribeDirectory", stream: "server", requestType: "SubscribeDirectoryReq", responseType: "DirectoryTableEvent", errorType: "SubscribeDirectoryError" },
  { id: 7, name: "ReadFile", stream: "server", requestType: "ReadFileReq", responseType: "ReadFileChunk", errorType: "ReadFileError" },
  { id: 8, name: "WriteFile", stream: "client", requestType: "WriteFileReq", responseType: "WriteFileResult", errorType: "WriteFileError" },
  { id: 9, name: "CreateNodes", stream: "unary", requestType: "CreateNodesReq", responseType: "BulkMutationRes", errorType: "FsMutationError" },
  { id: 10, name: "RenamePaths", stream: "unary", requestType: "RenamePathsReq", responseType: "BulkMutationRes", errorType: "FsMutationError" },
  { id: 11, name: "DeletePaths", stream: "unary", requestType: "DeletePathsReq", responseType: "BulkMutationRes", errorType: "FsMutationError" },
  { id: 12, name: "CreateTerminalSession", stream: "unary", requestType: "CreateTerminalSessionReq", responseType: "TerminalSessionInfo", errorType: "CreateTerminalSessionError" },
  { id: 13, name: "SubscribeTerminalSessions", stream: "server", requestType: "void", responseType: "TerminalSessionsTableEvent", errorType: "SubscribeTerminalSessionsError" },
  { id: 14, name: "SubscribeAvailableShells", stream: "server", requestType: "void", responseType: "AvailableShellsTableEvent", errorType: "SubscribeAvailableShellsError" },
  { id: 15, name: "AttachTerminalSession", stream: "server", requestType: "AttachTerminalSessionReq", responseType: "TerminalEvent", errorType: "AttachTerminalSessionError" },
  { id: 16, name: "TakeTerminalControl", stream: "unary", requestType: "TakeTerminalControlReq", responseType: "TakeTerminalControlRes", errorType: "TakeTerminalControlError" },
...
export const procs = {
  ...
  completePairing: completePairingProc,
  renewClientCredential: renewClientCredentialProc,
  subscribeRoots: subscribeRootsProc,
  subscribeDirectory: subscribeDirectoryProc,
  readFile: readFileProc,
  writeFile: writeFileProc,
  createNodes: createNodesProc,
  renamePaths: renamePathsProc,
  deletePaths: deletePathsProc,
  createTerminalSession: createTerminalSessionProc,
  subscribeTerminalSessions: subscribeTerminalSessionsProc,
  subscribeAvailableShells: subscribeAvailableShellsProc,
  attachTerminalSession: attachTerminalSessionProc,
  takeTerminalControl: takeTerminalControlProc,
