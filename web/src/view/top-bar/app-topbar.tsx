...
const globalTopbarClassName = [
  ...
  "items-center gap-[14px] h-[1.6em] min-h-[1.6em] min-w-0 overflow-hidden",
...
const globalIconButtonClassName = [
  "inline-flex appearance-none items-center justify-center w-[1.6em] min-w-[1.6em] h-[1.6em] min-h-[1.6em]",
...
const globalMachineTitleClassName = [
  ...
  "font-700",
  "[&_span]:min-w-0 [&_span]:overflow-hidden [&_span]:text-[0.8rem] [&_span]:leading-[1.6]",
