...
const headerClassName = [
  ...
  "border-b border-b-[var(--wgo-border-muted)] px-[16px] py-[14px]",
  "[&_div]:grid [&_div]:min-w-0 [&_div]:gap-[2px]",
].join(" ");
const eyebrowClassName = "text-[12px] font-700 text-[var(--wgo-text-tertiary)]";
const titleClassName =
  "m-0 text-[18px] font-700 tracking-[0] text-[var(--wgo-text-primary)]";
