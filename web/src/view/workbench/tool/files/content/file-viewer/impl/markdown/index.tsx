...
const markdownContentClassName = [
  "markdown-viewer min-w-0 min-h-0 overflow-auto bg-[var(--wgo-bg-primary)]",
  "px-[28px] py-[22px] text-[var(--wgo-text-primary)] text-[14px] leading-[1.65]",
  "[&_>*:first-child]:mt-0 [&_>*:last-child]:mb-0",
  "[&_a]:text-[var(--wgo-link)] [&_a]:font-650 [&_a]:underline",
  "[&_blockquote]:m-0 [&_blockquote]:my-[14px] [&_blockquote]:border-l-[3px]",
  "[&_blockquote]:border-l-[var(--wgo-border-control-soft)] [&_blockquote]:pl-[14px]",
  "[&_blockquote]:text-[var(--wgo-text-secondary)]",
  "[&_code]:rounded-[4px] [&_code]:bg-[var(--wgo-bg-code)] [&_code]:px-[4px]",
  "[&_code]:py-[1px] [&_code]:font-mono [&_code]:text-[13px]",
  "[&_pre]:my-[14px] [&_pre]:overflow-auto [&_pre]:rounded-[6px]",
  "[&_pre]:bg-[var(--wgo-bg-inverse)] [&_pre]:p-[14px] [&_pre]:text-[var(--wgo-text-inverse)]",
  "[&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_pre_code]:text-inherit",
  "[&_h1]:mb-[12px] [&_h1]:mt-[4px] [&_h1]:border-b",
  "[&_h1]:border-b-[var(--wgo-border-light)] [&_h1]:pb-[8px] [&_h1]:text-[24px]",
  "[&_h1]:leading-[1.25]",
  "[&_h2]:mb-[10px] [&_h2]:mt-[20px] [&_h2]:text-[19px]",
  "[&_h2]:leading-[1.3]",
  "[&_h3]:mb-[8px] [&_h3]:mt-[16px] [&_h3]:text-[16px]",
  "[&_hr]:my-[18px] [&_hr]:border-0 [&_hr]:border-t",
  "[&_hr]:border-t-[var(--wgo-border-light)]",
  "[&_li]:my-[4px] [&_ol]:pl-[24px] [&_ul]:pl-[24px]",
  "[&_p]:my-[11px]",
  "[&_table]:my-[14px] [&_table]:border-collapse [&_table]:text-[13px]",
  "[&_td]:border [&_td]:border-[var(--wgo-border-light)] [&_td]:px-[8px] [&_td]:py-[6px]",
  "[&_th]:border [&_th]:border-[var(--wgo-border-light)] [&_th]:bg-[var(--wgo-bg-subtle)]",
