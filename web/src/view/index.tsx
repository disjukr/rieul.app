...
const appShellClassName = [
  ...
  "max-[680px]:[&.workbench-tab-dnd-active]:!overflow-x-hidden",
  "max-[680px]:[&.workbench-tab-dnd-active]:![scroll-snap-type:none]",
  "max-[680px]:[&.workbench-tab-dnd-active]:select-none",
